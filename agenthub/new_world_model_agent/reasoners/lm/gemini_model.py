...
GEMINI_KEY = os.getenv(
    'GEMINI_KEY', None
)  # user need to set the environment variable GEMINI_KEY
        ...
        **kwargs,
        ...
        for i in range(1, retry + 1):
            try:
                ...
                return GenerateOutput(text=[response.text], log_prob=None)
        ...
        raise RuntimeError(
            'BardCompletionModel failed to generate output, even after 64 tries'
        )
    ...
    def get_next_token_logits(
        ...
        **kwargs,
        ...
        raise NotImplementedError(
            'BardCompletionModel does not support get_next_token_logits'
        )
