...
from reasoners.algorithm import (
    BeamSearchNode,
    BeamSearchResult,
    DFSNode,
    DFSResult,
...
from reasoners.visualization.tree_snapshot import (
    EdgeData,
    EdgeId,
    NodeData,
    NodeId,
...
class TreeLog:
        ...
        def default_node_data_factory(n: MCTSNode) -> NodeData:
            ...
            if hasattr(n.state, '_asdict'):
                ...
                try:
                    ...
                    raise TypeError(
                        'The type of the state is not supported. '
    ...
    @classmethod
    def from_beam_search_results(
        cls,
        bs_results: Union[BeamSearchResult, Sequence[BeamSearchResult]],
        node_data_factory: callable = None,
        edge_data_factory: callable = None,
    ) -> 'TreeLog':
